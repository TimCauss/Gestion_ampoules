                ...
                ?>
                    <tr>
                        ...
                        <td class="td-hover">
                            ...
                            <svg data-id="<?= $row["id"] ?>" onclick="EditToast()" id="check" class="modal-trigger3" width="14" height="14" stroke-width="0.541667" stroke="currentColor" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
